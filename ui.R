...
shinyUI(fluidPage(style = "margin-bottom: 20px",
    h1("You-Build-It Loan Performance Predicter", 
    ...
    fluidRow(
        column(4, style = "background-color: #E6F1F5; margin-left: 15px; padding-bottom: 15px",
            ...
            tags$ol(
                ...
                tags$li('Click "Run it!" to automatically fit a random forest model on a training set and then 
                        validate the model on another dataset'),
